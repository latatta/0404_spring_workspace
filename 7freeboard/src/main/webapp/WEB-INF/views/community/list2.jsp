...
<body>		<!-- list.jsp에서 pageNo 파라미터를 get으로 전달하는 것 post로 변경 -->
<h3>우리동네 커뮤니티</h3>
<hr>
<div style="margin:auto;">
 <table>
 	...
 	<c:forEach var="vo" items="${list}"> <!-- vo가 Freeboard타입  blists.getList() 실행-->
 						<!-- FreeboardController에서 list메소드에서 model.addAttribute를 통해 list 추가,
 								전송된 list를 사용 -->
	<tr>
 ...
 <div style="text-align: center;">
 	<!-- 가장 첫페이지로 이동 --><!-- href 대신에 onclick으로 변경해서 자바스크립트에서 처리 -->
...
<script type="text/javascript">
	function goPage(no) {		// 바뀔 페이지 번호가 no변수에 전달됩니다.
